...
import (
	...
	"github.com/jenkins-x/lighthouse-client/pkg/gittest"

	"github.com/jenkins-x/lighthouse-client/pkg/config/lighthouse"
	"github.com/jenkins-x/lighthouse-client/pkg/git/localgit"
	"github.com/jenkins-x/lighthouse-client/pkg/scmprovider/fake"
	"github.com/sirupsen/logrus"
	"k8s.io/apimachinery/pkg/util/sets"

	prowConf "github.com/jenkins-x/lighthouse-client/pkg/config"
)
