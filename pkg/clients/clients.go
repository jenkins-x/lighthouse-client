...
import (
	...
	clientset "github.com/jenkins-x/lighthouse-client/pkg/client/clientset/versioned"
	...
	//  import the auth plugin package - see https://github.com/jenkins-x/lighthouse-client/issues/928
