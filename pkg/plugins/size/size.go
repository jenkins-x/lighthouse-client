...
import (
	...
	"github.com/jenkins-x/lighthouse-client/pkg/genfiles"
	"github.com/jenkins-x/lighthouse-client/pkg/gitattributes"
...
func isPRChanged(pe scm.PullRequestHook) bool {
	switch pe.Action {
	case scm.ActionOpen:
		return true
