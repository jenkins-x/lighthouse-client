...
func TestListBuilds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			requestedJobs: []BuildQueryParams{{JobName: "unit", LighthouseJobID: "unitpj"}, {JobName: "unit", LighthouseJobID: "queued_pj_id"}, {JobName: "integration", LighthouseJobID: "integrationpj"}, {JobName: "e2e", LighthouseJobID: "e2epj"}},
			builds: map[string][]Build{
				"unit": {
					{Number: 1, Result: strP(success), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "first"}, {Name: lighthouseJobID, Value: "first"}}}}},
					{Number: 2, Result: strP(failure), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "second"}, {Name: lighthouseJobID, Value: "second"}}}}},
					{Number: 3, Result: strP(failure), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "third"}, {Name: lighthouseJobID, Value: "third"}}}}},
					{Number: 4, Result: strP(unstable), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "fourth"}, {Name: lighthouseJobID, Value: "fourth"}}}}},
				},
				"integration": {
					{Number: 1, Result: strP(failure), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "first-int"}, {Name: lighthouseJobID, Value: "first-int"}}}}},
					{Number: 2, Result: strP(success), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "second-int"}, {Name: lighthouseJobID, Value: "second-int"}}}}},
				},
			},

			expectedResults: map[string]Build{
				"first":      {Number: 1, Result: strP(success), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "first"}, {Name: lighthouseJobID, Value: "first"}}}}},
				"second":     {Number: 2, Result: strP(failure), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "second"}, {Name: lighthouseJobID, Value: "second"}}}}},
				"third":      {Number: 3, Result: strP(failure), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "third"}, {Name: lighthouseJobID, Value: "third"}}}}},
				"fourth":     {Number: 4, Result: strP(unstable), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "fourth"}, {Name: lighthouseJobID, Value: "fourth"}}}}},
				"first-int":  {Number: 1, Result: strP(failure), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "first-int"}, {Name: lighthouseJobID, Value: "first-int"}}}}},
				"second-int": {Number: 2, Result: strP(success), Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "second-int"}, {Name: lighthouseJobID, Value: "second-int"}}}}},
				// queued_pj_id is returned from the testWrapper
				"queued_pj_id": {Number: 0, Result: nil, Actions: []Action{{Parameters: []Parameter{{Name: statusBuildID, Value: "queued-int"}, {Name: lighthouseJobID, Value: "queued_pj_id"}}}}, enqueued: true, Task: Task{Name: "PR-763"}},
			},
		},
		{
			name: "bad error",
			...
			requestedJobs: []BuildQueryParams{{JobName: "unit", LighthouseJobID: "jobidhere"}},
			status:        intP(502),
...
func TestBuildCreate(t *testing.T) {
	testCases := []struct {
		name        string
		input       *v1alpha1.LighthouseJobSpec
		expectError bool
		statusCode  int
		output      []string
	}{
		{
			...
			input: &v1alpha1.LighthouseJobSpec{
				...
				JenkinsSpec: &v1alpha1.JenkinsSpec{
					BranchSourceJob: true,
				},
				Refs: &v1alpha1.Refs{
					Org:     "acme",
					BaseRef: "master",
			...
			statusCode: 201,
			output: []string{
				"/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/api/json",
				"/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/build",
				"/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/api/json",
				"/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/5/stop",
				"/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/buildWithParameters",
			},
		},
		{
			...
			statusCode: 201,
			output: []string{
				"/job/acme/job/my-jenkins-job-name/job/master/api/json",
				"/job/acme/job/my-jenkins-job-name/job/master/build",
				"/job/acme/job/my-jenkins-job-name/job/master/api/json",
				"/job/acme/job/my-jenkins-job-name/job/master/5/stop",
				"/job/acme/job/my-jenkins-job-name/job/master/buildWithParameters",
			},
		},
		{
...
func TestGetJobName(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			output: "acme/job/my-jenkins-job-name/view/change-requests/job/PR-123",
		},
		{
			name: "GitHub Branch Source based branch job",
			input: &v1alpha1.LighthouseJobSpec{
			...
			output: "acme/job/my-jenkins-job-name/job/master",
		},
		{
			name: "Static Jenkins job",
			input: &v1alpha1.LighthouseJobSpec{
...
func TestGetJobInfoPath(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			output: "/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/api/json",
		},
		{
			name: "GitHub Branch Source based branch job",
			input: &v1alpha1.LighthouseJobSpec{
			...
			output: "/job/acme/job/my-jenkins-job-name/job/master/api/json",
		},
		{
			name: "Static Jenkins job",
			input: &v1alpha1.LighthouseJobSpec{
...
func TestGetBuildPath(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			output: "/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/build",
		},
		{
			name: "GitHub Branch Source based branch job",
			input: &v1alpha1.LighthouseJobSpec{
			...
			output: "/job/acme/job/my-jenkins-job-name/job/master/build",
		},
		{
			name: "Static Jenkins job",
			input: &v1alpha1.LighthouseJobSpec{
...
func TestGetBuildWithParametersPath(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			output: "/job/acme/job/my-jenkins-job-name/view/change-requests/job/PR-123/buildWithParameters",
		},
		{
			name: "GitHub Branch Source based branch job",
			input: &v1alpha1.LighthouseJobSpec{
			...
			output: "/job/acme/job/my-jenkins-job-name/job/master/buildWithParameters",
		},
		{
			name: "Static Jenkins job",
			input: &v1alpha1.LighthouseJobSpec{
